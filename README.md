...
Goto [Official Web](https://github.com/KidiXDev/TrackMyPlaytime) or enter the [Release](https://github.com/KidiXDev/TrackMyPlaytime/releases) section and then just download the latest available release.
